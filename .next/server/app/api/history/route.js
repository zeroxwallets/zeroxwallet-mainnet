...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hashgraph/sdk */ \"(rsc)/./node_modules/@hashgraph/sdk/lib/index.js\");\n\n\nasync function GET() {\n    try {\n        const client = _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.Client.forTestnet().setOperator(process.env.HEDERA_ACCOUNT_ID, process.env.HEDERA_PRIVATE_KEY);\n        const records = await new _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.AccountRecordsQuery().setAccountId(process.env.HEDERA_ACCOUNT_ID).execute(client);\n        const txns = records.slice(0, 5).map((record)=>({\n                transactionId: record.transactionId.toString(),\n                consensusTimestamp: record.consensusTimestamp.toDate().toISOString(),\n                transfers: record.transfers.map((t)=>({\n                        account: t.accountId.toString(),\n                        amount: t.amount.toString()\n                    }))\n            }));\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            history: txns\n        });\n    } catch (err) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: err.message\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/history/route.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fhistory%2Froute&page=%2Fapi%2Fhistory%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fhistory%2Froute.ts&appDir=%2Fworkspaces%2FZeroxwallet-testnet%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fworkspaces%2FZeroxwallet-testnet&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
