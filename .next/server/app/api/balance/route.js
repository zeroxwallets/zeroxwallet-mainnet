...
(() => {
var exports = {};
exports.id = "app/api/balance/route";
exports.ids = ["app/api/balance/route"];
exports.modules = {

/***/ "(rsc)/./app/api/balance/route.ts":
/*!**********************************!*\
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hashgraph/sdk */ \"(rsc)/./node_modules/@hashgraph/sdk/lib/index.js\");\n\n\nfunction hederaClient() {\n    const accountId = process.env.HEDERA_ACCOUNT_ID;\n    const privateKey = process.env.HEDERA_PRIVATE_KEY;\n    if (!accountId || !privateKey) {\n        throw new Error(\"Missing Hedera environment variables\");\n    }\n    const client = _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.Client.forTestnet();\n    client.setOperator(accountId, _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.PrivateKey.fromString(privateKey));\n    return client;\n}\nasync function GET() {\n    try {\n        const accountId = process.env.HEDERA_ACCOUNT_ID;\n        const client = hederaClient();\n        const balance = await new _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.AccountBalanceQuery().setAccountId(accountId).execute(client);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            balance: balance.hbars.toString()\n        });\n    } catch (err) {\n        console.error(\"Error fetching balance:\", err);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"Failed to fetch balance\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/balance/route.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fbalance%2Froute&page=%2Fapi%2Fbalance%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fbalance%2Froute.ts&appDir=%2Fworkspaces%2FZeroxwallet-testnet%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fworkspaces%2FZeroxwallet-testnet&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
