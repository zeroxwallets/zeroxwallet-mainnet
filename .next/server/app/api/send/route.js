...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @hashgraph/sdk */ \"(rsc)/./node_modules/@hashgraph/sdk/lib/index.js\");\n/* harmony import */ var _lib_hedera__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../lib/hedera */ \"(rsc)/./lib/hedera.ts\");\n\n\n\nasync function POST(req) {\n    try {\n        const { accountId, amount } = await req.json();\n        console.log(\"API received:\", accountId, amount);\n        // Validation\n        if (!accountId || !amount) {\n            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n                error: \"Missing fields\"\n            }, {\n                status: 400\n            });\n        }\n        // Create transaction\n        const transaction = new _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.TransferTransaction().addHbarTransfer(_lib_hedera__WEBPACK_IMPORTED_MODULE_2__[\"default\"].operatorAccountId, new _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.Hbar(-amount)) // sender\n        .addHbarTransfer(_hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.AccountId.fromString(accountId), new _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_1__.Hbar(amount)); // receiver\n        // Execute\n        const txResponse = await transaction.execute(_lib_hedera__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n        // Receipt\n        const receipt = await txResponse.getReceipt(_lib_hedera__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            status: receipt.status.toString(),\n            transactionId: txResponse.transactionId.toString()\n        });\n    } catch (error) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: error.message || \"Transaction failed\"\n        }, {\n            status: 500\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/send/route.ts\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @hashgraph/sdk */ \"(rsc)/./node_modules/@hashgraph/sdk/lib/index.js\");\n\nconst accountId = process.env.HEDERA_ACCOUNT_ID;\nconst privateKey = process.env.HEDERA_PRIVATE_KEY;\nif (!accountId || !privateKey) {\n    throw new Error(\"Missing Hedera environment variables\");\n}\nconst client = _hashgraph_sdk__WEBPACK_IMPORTED_MODULE_0__.Client.forTestnet();\nclient.setOperator(accountId, privateKey);\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (client);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./lib/hedera.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fsend%2Froute&page=%2Fapi%2Fsend%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fsend%2Froute.ts&appDir=%2Fworkspaces%2FZeroxwallet-testnet%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fworkspaces%2FZeroxwallet-testnet&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
...
var __webpack_exports__ = __webpack_require__.X(0, ["vendor-chunks/next","vendor-chunks/@hashgraph","vendor-chunks/@grpc","vendor-chunks/protobufjs","vendor-chunks/@noble","vendor-chunks/@ethersproject","vendor-chunks/asn1js","vendor-chunks/long","vendor-chunks/bn.js","vendor-chunks/bignumber.js","vendor-chunks/forge-light","vendor-chunks/tweetnacl","vendor-chunks/pino","vendor-chunks/@protobufjs","vendor-chunks/@js-sdsl","vendor-chunks/js-sha3","vendor-chunks/fast-redact","vendor-chunks/safe-stable-stringify","vendor-chunks/lodash.camelcase","vendor-chunks/sonic-boom","vendor-chunks/thread-stream","vendor-chunks/pvtsutils","vendor-chunks/pvutils","vendor-chunks/pino-std-serializers","vendor-chunks/rfc4648","vendor-chunks/quick-format-unescaped","vendor-chunks/on-exit-leak-free","vendor-chunks/atomic-sleep"], () => (__webpack_exec__("(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Fsend%2Froute&page=%2Fapi%2Fsend%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Fsend%2Froute.ts&appDir=%2Fworkspaces%2FZeroxwallet-testnet%2Fapp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=%2Fworkspaces%2FZeroxwallet-testnet&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!")));
